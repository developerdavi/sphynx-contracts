...
//    _____ _____  _    ___     ___   ___   __  ______      _____  __  __
//   / ____|  __ \| |  | \ \   / / \ | \ \ / / |  ____/\   |  __ \|  \/  |
//  | (___ | |__) | |__| |\ \_/ /|  \| |\ V /  | |__ /  \  | |__) | \  / |
//   \___ \|  ___/|  __  | \   / | . ` | > <   |  __/ /\ \ |  _  /| |\/| |
//   ____) | |    | |  | |  | |  | |\  |/ . \  | | / ____ \| | \ \| |  | |
...
// Modified by Sphynx Network to work for non-mintable BEP-20.
// MASTERCHEF: @developerdavi
contract SphynxFarm is Ownable {
    using SafeMath for uint256;
    ...
    function fund(uint256 _amount) public {
        require(
            ...
            "SPX-Fund: Too late, the farm is closed!"
        );
    ...
    function add(
        ...
        for (uint256 index = 0; index < poolInfo.length; index++) {
            require(
                ...
                "SPX-Add: you can not add the same LP token twice"
            );
        }
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        require(
            user.amount >= _amount,
            "SPX-withdraw: Cannot withdraw more than deposit"
        );
        updatePool(_pid);
        uint256 pendingAmount = user
        .amount
